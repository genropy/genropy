...
:meth:`~gnr.app.gnrsqltable_proxy.selection.SelectionProxy.loadSavedQuery`
and :meth:`~gnr.app.gnrsqltable_proxy.selection.SelectionProxy.loadSavedView`
...
class GnrWebAppHandlerNext(GnrWebAppHandler):
    ...
    def _externalQueries(self, selection: Any = None,
        ...
        selection.dbtable.selectionProxy().externalQueries(
