...
class SqlTable(GnrObject):
    ...
    def variantColumn_masked(self, field, mode='2-4', placeholder='*', **kwargs):
        ...
        The actual SQL formula is generated by the database adapter, allowing
        database-specific implementations. PostgreSQL and SQLite are supported.
        Other adapters will emit a warning and return the field unmasked.
        ...
        """
        # Use the $ prefix for gnr field substitution
        field_ref = f'${field}'
        sql_formula = self.db.adapter.mask_field_sql(field_ref, mode=mode, placeholder=placeholder)
