...
class DbModel(object):
    ...
    def addRelation(self, many_relation_tuple, oneColumn, mode=None,storename=None, one_one=None, onDelete=None, onDelete_sql=None,
                    ...
                    between=None, cnd=None, virtual=None,ignore_tenant=None,**kwargs):
    ...
    def column(self, name, dtype=None, size=None,
        ...
        if ext_kwargs:
            for pkgExt,extKwargs in ext_kwargs.items():
                ...
                if handler:
                    handler(self,colname=name,colattr=result.attributes,**extKwargs)
                    return result
        return result
...
class RelationTreeResolver(BagResolver):
    ...
    def _fields(self, table, pkg_name, path=None, parentpath=None):
        ...
        manyrels = []
        if relations:
            onerels = {a['many_relation'].replace('.', '_'):(lbl, a)
