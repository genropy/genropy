...
class Main(BaseResourceAction):
    ...
    def step_get_dependencies(self):
        ...
        self.source_folder = self.page.site.getStaticPath('home:export_archive','source',name)
        self.archive_path = self.page.site.getStaticPath('home:export_archive','source',name,'records',autocreate=True)
        self.files_to_copy = self.page.site.getStaticPath('home:export_archive','source',name,'files',autocreate=True)
        self.result_path = self.page.site.getStaticPath('home:export_archive','results','%s.zip' %name,autocreate=-1)
        self.result_url = self.page.site.getStaticUrl('home:export_archive','results','%s.zip' %name)
