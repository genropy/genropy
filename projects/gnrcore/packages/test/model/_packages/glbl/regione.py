...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.formulaColumn('province_principali_nome',self.db.adapter.string_agg('#prov_nomi',separator=','),
        ...
        tbl.formulaColumn('province_principali_nome_nuts',self.db.adapter.string_agg('#prov_nomi',separator=','),
