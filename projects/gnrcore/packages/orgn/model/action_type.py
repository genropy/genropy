...
class Table(object):
    ...
    def runImplementor(self,action_id=None,implementor=None,**kwargs):
        return getattr(self,'impl_{implementor}'.format(implementor=implementor))(action_id,**kwargs)
    ...
    def _SMS_get_number(self,action_id=None):
        ...
        return record_action['@{fkey}.{sms_number_path}'.format(fkey=fkey,sms_number_path=sms_number_path)]
