...
class Form(BaseComponent):
    ...
    def smtp_parameters(self, bc):
        ...
        fb.field('use_mailproxy')
        fb.field('proxy_ttl',hidden='^.use_mailproxy?=!#v')
        fb.field('proxy_limit_per_minute',hidden='^.use_mailproxy?=!#v')
        fb.field('proxy_limit_per_hour',hidden='^.use_mailproxy?=!#v')
        fb.field('proxy_limit_per_day',hidden='^.use_mailproxy?=!#v')
        fb.field('proxy_limit_behavior',hidden='^.use_mailproxy?=!#v')
        fb.field('proxy_batch_size',hidden='^.use_mailproxy?=!#v')
